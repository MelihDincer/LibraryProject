...
namespace MvcKutuphane.Controllers
{
    public class OduncController : Controller
    {
        ...
        {
            List<SelectListItem> deger1 = (from x in db.TBLUYELER
            ...
            List<SelectListItem> deger2 = (from y in db.TBLKITAP.Where(x=>x.DURUM == true)
                                           select new SelectListItem
                                           {
                                               Text = y.AD,
                                               Value = y.ID.ToString(),
            ...
            List<SelectListItem> deger3 = (from z in db.TBLPERSONEL
                                           select new SelectListItem
                                           {
                                               Text = z.PERSONEL,
                                               Value = z.ID.ToString()
